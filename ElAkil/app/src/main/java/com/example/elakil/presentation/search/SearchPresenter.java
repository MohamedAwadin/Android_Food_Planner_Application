...
public class SearchPresenter implements SearchContract.Presenter{
    ...
    public void loadFilters() {
            ...
            public void onSuccess(CountryListResponse response) {
                if (response != null && response.getCountries() != null){
                    ...
                    for (Country country : response.getCountries()){
                        ...
                        allAreas.add(new FilterItem(areaName, flagResource, "country"));
                        //areaNames.add(areaName);
                    }
                    //view.setAreaSpinner(areaNames);
                    if (currentFilterType.equals("country")){
        ...
        view.setSelectedFilter(currentFilterType);
    ...
    public void onFilterButtonClicked(String filterType) {
        ...
        view.setSelectedFilter(filterType);
        onSearchTextChanged("");
